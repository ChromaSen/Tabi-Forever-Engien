...
class ChartingState extends MusicBeatState
{
	...
	private function regenerateSection(section:Int, placement:Float)
	{
		...
		for (i in 0...2)
		{
			...
			sectionNumber.setFormat(Paths.font("lato_bold.ttf"), 24, FlxColor.WHITE);
	...
	private function generateBackground()
	{
		...
		#else
		coolGrid = new FlxBackdrop(Paths.image('UI/forever/base/chart editor/grid'), XY);
		coolGrid.velocity.set(40, 40);
		#end
