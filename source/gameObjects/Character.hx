...
class Character extends FNFSprite
{
	...
	public function setCharacter(x:Float, y:Float, character:String):Character
	{
		...
		switch (curCharacter)
		{
			...
			case 'gf-exp':
				// GIRLFRIEND CODE
				tex = Paths.getSparrowAtlas('characters/PostExpGF_Assets');
				frames = tex;
			...
			case 'bf-tabi':
				frames = Paths.getSparrowAtlas('characters/BOYFRIEND_TABI');
			...
			case 'bf-dead-knife':
				frames = Paths.getSparrowAtlas('characters/BF_Knife_death');
